...
- Validate the immutable Lineuparr `v1.26.2472002-beta.1` tag, exact source composition, inner plugin archive layout and metadata, generated-import checks, source matcher gates, and development manifest history; stable registry and deployment remain separately scoped.
