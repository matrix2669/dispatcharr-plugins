...
- Current Stream Sort build: beta `0.3.6-beta.7` from source commit `adb0005296079c9133dba755866d3a81724b7fa3`; the immutable tag archive preserves `stream_sorter/plugin.json`, reports the synchronized beta.7 version, compiles, and passes all 122 source tests.
