...
- Validation plan: exact remote tag and GitHub archive verification, development registry validator, all registry unit tests, JSON parsing, prior-version retention, complete-diff review, published raw-manifest checks, and installed Dispatcharr update validation.
