...
| `feature/lineuparr-v1.26.2472002-beta.1` | feature | in progress | `dev` at `0067dbd` | `dev` | Advance Lineuparr to the generated-lineup URL import beta. |
...
- Validation: source static validation, generated-import checks, Python compilation, core/client parity, 307-output matcher golden gate, exact remote branch/tag verification, and downloaded archive inspection pass; registry validation and publication checks are pending
...
- Current Lineuparr build: beta `1.26.2471558-beta.1` from source composition `f03ea7e1746e48640c94028758ba3325d0ceef62`; source/archive checks, development workflow `33893350037`, and public root/detail/icon verification pass. Stable `main` remains absent, upstream remains the stable production source, and managed installation is pending separate authorization.
